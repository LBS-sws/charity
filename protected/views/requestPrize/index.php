...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('app','Apply Charity Prize'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
    <div class="box">
        <div class="box-body">
            <div class="btn-group" role="group">
                ...
                if (Yii::app()->user->validRWFunction('CY02'))
                    echo TbHtml::button('<span class="fa fa-file-o"></span> '.Yii::t('misc','Add'), array(
                        'submit'=>Yii::app()->createUrl('requestPrize/new'),
                    ));
                ?>
            </div>
            <div class="pull-right" style="line-height: 34px;">
                <?php
                $list = RequestPrizeForm::getCreditSumToYear();
                echo Yii::t("charity","Sum Gift")."：".$list["start_num"];
                echo "&nbsp; &nbsp; &nbsp; &nbsp;";
                echo Yii::t("charity","Available Gift")."：".$list["end_num"];
                ?>
            </div>
        </div>
    </div>
    ...
    $this->widget('ext.layout.ListPageWidget', array(
        'title'=>Yii::t('charity','Request Prize List'),
        'model'=>$model,
        'viewhdr'=>'//requestPrize/_listhdr',
        'viewdtl'=>'//requestPrize/_listdtl',
        'gridsize'=>'24',
        'height'=>'600',
