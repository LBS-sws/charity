<?php
$this->pageTitle=Yii::app()->name . ' - Prize type allocation';
?>
...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('app','Charity Prize Search'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
    ...
    $this->widget('ext.layout.ListPageWidget', array(
        ...
        'model'=>$model,
        'viewhdr'=>'//searchPrize/_listhdr',
        'viewdtl'=>'//searchPrize/_listdtl',
        'gridsize'=>'24',
        'height'=>'600',
